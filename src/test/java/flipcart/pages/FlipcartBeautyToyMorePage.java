...
public class FlipcartBeautyToyMorePage extends TestBase{
	...
	public FlipcartBeautyToyMorePage() {
		PageFactory.initElements(driver, this);
	}
	
	public FlipcartBeautyToyMorePage verifyFlipcartTitle() {
