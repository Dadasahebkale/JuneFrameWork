...
public class FlipcartFashionPage extends TestBase{
	...
	public FlipcartFashionPage() {
		PageFactory.initElements(driver, this);
	}
	
	public FlipcartFashionPage verifyFlipcartTitle() {
	...
	public FlipcartFashionPage VerifyFlipCarMobilePageTest() {
	x.isDisplayed();
	x.click();
	fashon.isDisplayed();
	fashon.click();
